...
本着开源的精神, 我决定继续维护这个项目, 继续站在[tk](https://github.com/TKkk-iOSer)大佬的肩膀上战斗, 对[tk](https://github.com/TKkk-iOSer)在此表示感谢! 另外, 这是一个方便大家使用的免费项目, 我也只是承担维护工作, 不会向任何人收取费用(听闻某宝收费安装, 致富经)
...
## 注意 log
2019-5-10 现在在最新版的微信中的躲开和消息撤回是可以用的, 如果不能用, 请检查小助手的版本. 
