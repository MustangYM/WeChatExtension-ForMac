...
![platform](https://img.shields.io/badge/platform-macos-lightgrey.svg)  [![release](https://img.shields.io/badge/release-v2.4.3-brightgreen.svg)](https://github.com/MustangYM/WeChatExtension-ForMac/releases)  ![support](https://img.shields.io/badge/support-wechat%202.4.0-blue.svg)
...
## 黑夜模式
- 众多软件都适配了黑夜模式, 等了这么久Mac微信官方还是没做适配. 所以做了这个玩票功能, 少量细节没有做适配, 配色啥的就不要吐槽了, 毕竟当代梵高在线为大家作画.不影响正常使用, 如果你是强迫症加完美主义, 可能不太适合. (我挺想做一款少女粉的背景, 你们喜欢吗?)
<p align="center">
